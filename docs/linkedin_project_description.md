...
I built the backend with FastAPI, SQLAlchemy, SQLite, Pydantic, and pytest, added a lightweight HTML/CSS/JavaScript frontend, containerized the app with Docker, configured GitHub Actions CI, and deployed the project on Render.
